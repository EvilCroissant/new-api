...
func InitOptionMap() {
	...
	common.OptionMap["InvitationRewardRateBps"] = strconv.Itoa(common.InvitationRewardRateBps)
...
func MigrateInvitationRewardOptions() error {
	return DB.Where("key IN ?", []string{"QuotaForInviter", "QuotaForInvitee"}).Delete(&Option{}).Error
}
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InvitationRewardRateBps":
		common.InvitationRewardRateBps, _ = strconv.Atoi(value)
