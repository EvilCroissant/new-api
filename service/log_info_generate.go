...
func appendRelayLogAdminInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, other *model.LogOther, requestSucceeded bool) {
...
func AppendRelayLogAdminInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, other *model.LogOther) {
	appendRelayLogAdminInfo(ctx, relayInfo, other, true)
}

func AppendRelayErrorLogAdminInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, other *model.LogOther) {
	appendRelayLogAdminInfo(ctx, relayInfo, other, false)
}
...
func GenerateTextOtherInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelRatio, groupRatio, completionRatio float64,
	...
	if frtMs, ok := relayInfo.FRTMilliseconds(); ok {
		other.SetPublic("frt", float64(frtMs))
	}
