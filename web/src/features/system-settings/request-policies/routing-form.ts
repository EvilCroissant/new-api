  ...
  return {
    ...
    channel_affinity_setting: {
      ...
      optimization_enabled:
        options['channel_affinity_setting.optimization_enabled'] === 'true',
      ...
      frt_consecutive_slow_limit: Number(
        options['channel_affinity_setting.frt_consecutive_slow_limit']
      ),
      frt_all_slow_hold_seconds: Number(
        options['channel_affinity_setting.frt_all_slow_hold_seconds']
      ),
      switch_on_success:
